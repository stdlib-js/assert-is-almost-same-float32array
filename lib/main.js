...
*
* var out = isAlmostSameFloat32Array( x, y, 1 );
* // returns false
*/
function isAlmostSameFloat32Array( v1, v2, maxULP ) {
	return ( isFloat32Array( v1 ) && isFloat32Array( v2 ) && hasAlmostSameValues( v1, v2, maxULP ) );  // eslint-disable-line max-len
}


// EXPORTS //

module.exports = isAlmostSameFloat32Array;
